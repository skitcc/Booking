...
public class films extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filmsList.add(new film(1,"pauk","Человек Паук Нет Пути Домой","4 апреля","#c41e3a",
        ...
        filmsList.add(new film(2,"venom","Веном 2","4 апреля","black","Science fiction","Более чем через год после тех событий журналист Эдди Брок пытается приспособиться к жизни в качестве хозяина инопланетного симбиота Венома, который наделяет его сверхчеловеческими способностями. Брок пытается возродить свою карьеру и берет интервью у серийного убийцы Клетуса Касади, который по воле случая становится хозяином Карнажа и сбегает из тюрьмы после неудавшейся казни."));
        filmsList.add(new film(3,"blood","Кровью и Потом", "5 апреля","#DC7633",
        ...
        filmsList.add(new film(4,"happy_day_death","Счастливого дня смерти", "6 апреля","#AB63AB",
        ...
        filmsList.add(new film(5,"kids_games","Детские игры", "6 апреля","black","Action movie","Мать-одиночка Карен дарит своему сыну Энди куклу, о которой мечтают все дети. Однако, вскоре становится ясно, что Энди достается больше, чем просто игрушка…"));
