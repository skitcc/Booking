...
public class films extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filmsList.add(new film(1,"pauk","Человек Паук Нет Пути Домой",CurrentTime,"#c41e3a",
                "Боевик","Жизнь и репутация Питера Паркера оказываются под угрозой, поскольку Мистерио раскрыл всему миру тайну личности Человека-паука. Пытаясь исправить ситуацию, Питер обращается за помощью к Стивену Стрэнджу, но вскоре всё становится намного опаснее."));
        filmsList.add(new film(2,"venom","Веном 2",CurrentTime,"black", "Научная фантастика","Более чем через год после тех событий журналист Эдди Брок пытается приспособиться к жизни в качестве хозяина инопланетного симбиота Венома, который наделяет его сверхчеловеческими способностями. Брок пытается возродить свою карьеру и берет интервью у серийного убийцы Клетуса Касади, который по воле случая становится хозяином Карнажа и сбегает из тюрьмы после неудавшейся казни."));
        filmsList.add(new film(3,"blood","Кровью и Потом", CurrentTime,"#DC7633",
                        "Криминальный фильм","Однажды тренеру по фитнесу надоело ходить в трениках. Он решил круто изменить свою судьбу и разбогатеть. Нашел двух других незадачливых качков и предложил им план похищения своего клиента-миллионера. Но если в организме мышц больше, чем мозгов, то даже самый лучший план, подсмотренный в экшен-боевике, может не сработать…"));
        filmsList.add(new film(4,"happy_day_death","Счастливого дня смерти", CurrentTime,"#AB63AB",
                  "Хоррор","Каждый в универе мечтал попасть на её день рождения, но праздник был безнадежно испорчен незнакомцем в маске, убившим виновницу торжества. Однако судьба преподнесла имениннице леденящий душу подарок — бесконечный запас жизней. И теперь у девушки появился шанс вычислить своего убийцу, ведь этот день будет повторяться снова и снова…"));
        filmsList.add(new film(5,"kids_games","Детские игры", CurrentTime,"black", "Боевик","Мать-одиночка Карен дарит своему сыну Энди куклу, о которой мечтают все дети. Однако, вскоре становится ясно, что Энди достается больше, чем просто игрушка…"));
